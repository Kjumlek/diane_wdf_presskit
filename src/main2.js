import * as THREE from 'three';
    ...
    const views = [
      { position: new THREE.Vector3(0, 0, 40), lookAt: new THREE.Vector3(0, 0, 0), rotationY: 0, rotationX: 0 },
      { position: new THREE.Vector3(40, 0, 50), lookAt: new THREE.Vector3(0, 0, 0), rotationY: Math.PI / .5, rotationX: Math.PI / .5 },
      { position: new THREE.Vector3(20, 0, 100), lookAt: new THREE.Vector3(0, 0, 0), rotationY: Math.PI / 3, rotationX: Math.PI / 6 },
      { position: new THREE.Vector3(0, 0, 30), lookAt: new THREE.Vector3(0, 0, 0), rotationY: Math.PI / 1, rotationX: Math.PI / 1 }
    ];
    ...
    function init() {
      ...
      loadModel('./models/Moon.obj', new THREE.Vector3(0, 0, 0), new THREE.Vector3(16, 16, 16), 1);
